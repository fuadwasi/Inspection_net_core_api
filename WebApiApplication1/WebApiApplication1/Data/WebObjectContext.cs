...
{
    public class WebObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public WebObjectContext(DbContextOptions<WebObjectContext> options) : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                if (typeConfiguration == null) continue;
        ...
        {
            return QueryFromSql<TQuery>(sql, parameters);
                //Query<TQuery>().FromSqlRaw(CreateSqlWithParameters(sql, parameters), parameters);
        }
